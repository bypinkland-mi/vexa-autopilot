...
| Latest GitHub CI passed | ready | https://github.com/bypinkland-mi/vexa-autopilot/actions/runs/28457963601; sha=ee600fb |
| Release contains required assets | ready | https://github.com/bypinkland-mi/vexa-autopilot/releases/tag/v0.1-qwen-hackathon; assets=DEVPOST_FINAL_PACKET.template.md, SUBMISSION_PACKAGE.md, bootstrap-ecs.sh, cloud-init.user-data.example, vexa-autopilot-qwen-hackathon.pptx, vexa-devpost-demo.mp4, vexa-local-demo.mp4, vexa-local-demo.webm |
